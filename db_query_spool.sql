...
SET ECHO OFF
SET COLSEP ';'
SPOOL M:\zue-prod\data_integration\DWH_Hydro_Services\Test_Decentlab_API\db_export.csv
...
AND WSP.REFERENCE_TS BETWEEN TO_DATE('2026-07-07 23:50:00', 'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('2026-07-09 08:38:59', 'YYYY-MM-DD HH24:MI:SS')
